#!/usr/bin/env python
# This file is part purchase_separate_credit_invoice module for Tryton.
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-purchase_separate_credit_invoice',
    download_url='https://github.com:nantic/trytond-purchase_separate_credit_invoice.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-purchase_separate_credit_invoice.git'
    },
    classifiers=[
